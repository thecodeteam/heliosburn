...
RUN sed -i "s/redis_host.*/redis_host="\'redis\'"/" /opt/HeliosBurn/heliosburn/hblog/hblog.py
RUN sed -i "s/mongodb_host.*/mongodb_host="\'mongo\'"/" /opt/HeliosBurn/heliosburn/hblog/hblog.py
